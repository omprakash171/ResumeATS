      ...
      <section className="hero">
        ...
        <div className="hero-content">
          ...
          <p className="hero-sub">
            Upload your resume, get an ATS score, and receive AI‑driven
            suggestions to make recruiters notice you.
          </p>
          <p className="hero-quote">
            "A great resume opens doors; this tool ensures it gets past the
            first one."
          </p>
      ...
      <section className="features-section">
        ...
        <div className="features-grid">
          {[
            ...
            },
            {
              ...
              desc: "Personalized, actionable edits and bullet rewrites powered by an LLM.",
            },
            {
              icon: "🔑",
            ...
            {
              icon: "📐",
              title: "Format & Layout Tips",
              desc: "Recommend resume sections and formatting to improve parsing.",
            },
            {
              icon: "🔒",
              title: "Secure & Private",
              desc: "Files are processed securely; user accounts protect your data.",
            },
          ].map((f, i) => (
            <div
        ...
        <div className="features-cta">
          ...
          <p className="trust-line">
            No credit card. Secure processing. Export in PDF.
          </p>
        </div>
      </section>
      ...
      <section className="how-section">
        <div className="section-header">
          ...
          <h2>
            Three Steps to
            <br />
            <span className="gradient-text">Resume Success</span>
          </h2>
        </div>
          ...
          {[
            {
              num: "01",
              title: "Upload",
              desc: "Drop a PDF or DOCX of your resume.",
            },
            {
              num: "02",
              title: "Analyze",
              desc: "Get an ATS score, keyword matches, and AI suggestions.",
            },
            {
              num: "03",
              title: "Improve",
              desc: "Apply edits, re-run analysis, download the optimized resume.",
            },
          ].map((s, i) => (
      ...
      <section className="benefits-section">
        <div className="benefits-text">
          ...
          <p className="benefits-desc">
            Resume ATS Analyzer helps jobseekers pass automated screening.
            Upload a resume, compare it with a job description, get a clear ATS
            score, and receive AI-powered edits to increase your chances of
            getting interviews.
          </p>
      ...
      <section className="cta-section">
        ...
        <div className="cta-content">
          <h2>
            Ready to Get More
            <br />
            <span className="gradient-text">Interview Callbacks?</span>
          </h2>
          <p>
