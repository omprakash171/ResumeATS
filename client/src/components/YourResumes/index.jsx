...
const YourResumes = () => {
  ...
  const handleUploadAndAnalyze = async () => {
    ...
    try {
      ...
      setAnalysisResult({ ...analyzeData, resumeText: data.text });
      setShowModal(true);
    ...
    <div className="resume-container">
      ...
      <div className="job-description-section">
        ...
        <textarea
          ...
          placeholder="Paste the job description you want to match your resume with..."
          value={jobDescription}
          onChange={handleJobDescriptionChange}
          rows="8"
        />
        <div className="textarea-helper-text">
